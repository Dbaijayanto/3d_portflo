...
var mydetails = [
  "Hi! My name is Baijayanta and I'm Msc Informatics student",
  "My projects include 'Portfolio , car animation window , expense calculator ",
  "My skills include C++,HTML,CSS,Javacript,MYSQL,GITHUB",
  "Contact : itsbaijayanta@gmail.com , ph:no: 9831371514",
];
var currentDetailIndex = 0;
var backgroundMusic = new Audio("bgm.mp3");
backgroundMusic.loop = true;
var burstSound = new Audio("pop.mp3");
...
function restartScene() {
  ...
  currentDetailIndex = (currentDetailIndex + 1) % mydetails.length; 
  updateDetail(); 

  myLevel.innerText =
    comments[level - 1] + ": Level " + level + " of " + totalLevels;
  scene.remove(holder);
  addHolder();
}
...
function updateDetail() {
  var detailElement = document.getElementById("detail-display");
  detailElement.innerText = mydetails[currentDetailIndex];
}
